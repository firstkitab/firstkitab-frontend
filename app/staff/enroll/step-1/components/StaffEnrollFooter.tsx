...
import { MdSaveAs, MdArrowForward } from 'react-icons/md';
    ...
    <>
      <div className="sticky bottom-0 z-10 w-full rounded bg-card/95 backdrop-blur border border-border p-4 shadow-xl flex justify-between items-center mt-2">
        ...
        <div className="flex gap-3">
          <button
            className="flex items-center gap-2 rounded px-5 py-2 text-sm font-bold text-muted-foreground/50 cursor-not-allowed"
            disabled
          >
            Previous
          </button>
